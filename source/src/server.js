...
if (!config.METERED_DOMAIN) {
    throw new Error(`Please specify the METERED_DOMAIN.\nAdd as an environment variable or 
                    in the .env file or directly specify in the src/config.js\n
                    If you are unsure where to get METERED_DOMAIN 
                    please read the Getting Started Guide here: https://docs.metered.ca/docs/getting-started`);
}
...
if (!config.METERED_SECRET_KEY) {
    throw new Error(`Please specify the METERED_SECRET_KEY.\nAdd as an environment variable or 
                    in the .env file or directly specify in the src/config.js\n
                    If you are unsure where to get METERED_SECRET_KEY 
                    please read the Getting Started Guide here: https://docs.metered.ca/docs/getting-started`);
}
